...
class AudioManager:
    SOUND_FILES = {
        ...
        "lifeline_click": ("lifeline_click.wav", "lifeline_click.mp3"),
        "lifeline_5050": (
            "lifeline_5050.mp3",
            "lifeline_5050.wav",
            "sfx_5050.mp3",
        ...
        "lifeline_call": ("lifeline_call.mp3", "lifeline_call.wav"),
        "lifeline_wise_man": ("lifeline_wise_man.mp3", "lifeline_wise_man.wav"),
        "wise_man_countdown": (
            "wise_man_countdown.mp3",
            "wise_man_countdown.wav",
            "lifeline_wise_man_30s.mp3",
            "lifeline_wise_man_30s.wav",
            "lifeline_call.mp3",
            "lifeline_call.wav",
        ),
        "win": "win.mp3",
        "complete": ("complete.mp3", "complete.wav"),
        "program_end": ("program_end.mp3", "program_end.wav"),
        "end_buzzer": ("end_buzzer.wav", "end_buzzer.mp3"),
        "viewer_game": ("viewer_game.mp3", "viewer_game.wav"),
        "viewer_prize": ("viewer_prize.mp3", "viewer_prize.wav"),
        "viewer_break": ("viewer_break.mp3", "viewer_break.wav"),
        "viewer_technical": ("viewer_technical.mp3", "viewer_technical.wav"),
        "viewer_blank": ("viewer_blank.wav", "viewer_blank.mp3"),
        "viewer_stats": ("viewer_stats.mp3", "viewer_stats.wav"),
        "viewer_credits": ("viewer_credits.mp3", "viewer_credits.wav"),
        "viewer_mini_quiz": ("viewer_mini_quiz.mp3", "viewer_mini_quiz.wav"),
        "viewer_poll": ("viewer_poll.mp3", "viewer_poll.wav"),
